...
class UndesirableAffiliate extends Model
{
    ...
    protected $fillable = [
        ...
        'date_added', 'reviwed_date', 'affiliate_price', 'total_sales_126', 'total_cost_126', 'gross_margin_126',
        'num_disputes_126', 'desirability_score', 'updated_price_name', 'updated_price'
    ];
}
